...
* Fill out the fields:
  ...
  * Authentication Name: http user name that was set in cclpbx default settings
  * Authentication Password: http password that was set in cclpbx default settings
