...
To connect to a fax machine with an ATA you will most likely need to adjust settings in the ATA web interface and in cclpbx.
...
* Turn on verbose log in FreeSWITCH fax.conf.xml
   * From your cclpbx installation go to ADVANCED > XML Editor and a new window will open.
